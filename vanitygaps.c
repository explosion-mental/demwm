/* All of what i consider "core" of vanitygaps are on dwm.c
 * since I don't plant to don't use gaps */
...
tile(Monitor *m)
{
	...
	//check if gaps are enabled
	//if (selmon->pertag->enablegaps[selmon->pertag->curtag])
        //snprintf(m->ltsymbol, sizeof m->ltsymbol, "[G]");
	//else
