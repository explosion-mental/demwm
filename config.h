...
static const unsigned int alphas[][2] = {
	...
	[BorderUrg]    = { OPAQUE },
	/* custom blocks schemes */
	[SchemeLast+0] = { OPAQUE,	baralpha + 40 },
	[SchemeLast+1] = { OPAQUE,	baralpha + 40 },
	[SchemeLast+2] = { OPAQUE,	baralpha + 40 },
	[SchemeLast+3] = { OPAQUE,	baralpha + 40 },
	[SchemeLast+4] = { OPAQUE,	baralpha + 40 },
};
...
//	{ SchemeStatus, "sb-price bat \"Basic Attention Token\" 🦁",9000,	20},
//	{ SchemeStatus, "sb-price lbc \"LBRY Token\" 📚",	9000,		22},
