...
static const Block blocks[] = {
	...
	{ color2, "sb-clock",				30,		1},
	{ fg_wal, "sb-disk",				9000,		2},
	{ fg_wal, "sb-battery",				10,		3},
	{ fg_wal, "sb-internet",			10,		4},
	{ fg_wal, "sb-mailbox",				0,		5},
	{ fg_wal, "sb-moonphase",			18000,		6},
	{ fg_wal, "sb-forecast",			18000,		7},
	{ fg_wal, "sb-volume",				0,		8},
//	{ fg_wal, "sb-price btc Bitcoin 💰",		9000,		21},
//	{ fg_wal, "sb-price eth Ethereum 🍸",		9000,		23},
//	{ fg_wal, "sb-price xmr \"Monero\" 🔒",		9000,		24},
//	{ fg_wal, "sb-price link \"Chainlink\" 🔗",	300,		25},
//	{ fg_wal, "sb-price bat \"Basic Attention Token\" 🦁",9000,	20},
//	{ fg_wal, "sb-price lbc \"LBRY Token\" 📚",	9000,		22},
//	{ fg_wal, "sb-cpu",				10,		18},
//	{ fg_wal, "sb-kbselect",			0,		30},
//	{ fg_wal, "sb-memory",				10,		14},
//	{ fg_wal, "sb-torrent",				20,		7},
//	{ fg_wal, "sb-crypto",				0,		13},
//	{ fg_wal, "sb-help-icon",			0,		15},
//	{ fg_wal, "sb-nettraf",				1,		16},
//	{ fg_wal, "sb-news",				0,		6},
//	{ fg_wal, "sb-xbpsup",				18000,		8},
	{ fg_wal, "sb-pacpackages",			0,		9},
	{ fg_wal, "sb-sync",				0,		10},
//	{ fg_wal, "sb-mpc",				0,		26},
	{ fg_wal, "sb-music",				0,		11},
//	{ fg_wal, "sb-tasks",				10,		12},
	{ fg_wal, "sb-notes",				0,		13},
	{ fg_wal, "cat /tmp/recordingicon 2>/dev/null",	0,		14},
//	{ fg_wal, "sb-count",				0,		21},
};
